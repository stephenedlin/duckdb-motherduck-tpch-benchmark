...
=============================================================
 ...
 OPTIONAL — run specific scale factors only:
   python motherduck_benchmark_v6.py --sf 1 5
   python motherduck_benchmark_v6.py --sf 10 20
   python motherduck_benchmark_v6.py --n 20          (target total run, default: 30)
   python motherduck_benchmark_v6.py --no-drop       (keep DB for debugging)
   python motherduck_benchmark_v6.py --log-file PATH (append ke log lama)
